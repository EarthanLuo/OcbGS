...
_rasterizer_cache = None


def _lazy_rasterizer():
    global _rasterizer_cache
    if _rasterizer_cache is None:
        from diff_gaussian_rasterization import GaussianRasterizationSettings, GaussianRasterizer
        _rasterizer_cache = (GaussianRasterizationSettings, GaussianRasterizer)
    return _rasterizer_cache
...
def render(viewpoint_camera, pc : GaussianModel, pipe, bg_color : torch.Tensor, scaling_modifier=1.0, visible_mask=None, retain_grad=False, ape_code=-1):
    ...
    GaussianRasterizationSettings, GaussianRasterizer = _lazy_rasterizer()
